...
ARG         KC_VERSION=9.0.2
ARG         DBC_VERSION=8.0.19
...
LABEL		org.opencontainers.image.documentation="https://github.com/Frickeldave/ContainerBase/README.md"
LABEL		org.opencontainers.image.source="https://github.com/Frickeldave/Container/Keycloak"
...
LABEL		de.frickeldave.containers.builnumber=$fd_buildnumber
